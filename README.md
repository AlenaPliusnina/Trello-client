...
Описание: 
    ...
    Это консольное приложение позволяет работать с Trello — одной из самых популярных систем управления проектами в режиме онлайн, 
    которая пользуется особенным спросом среди небольших компаний и стартапов. 
